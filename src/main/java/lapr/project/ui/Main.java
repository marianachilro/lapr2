...
//    ee44    Utilizador u = new Utilizador(2, "joao", "jo", "jo@centro.pt", "aB;1", "dpddd");
...
//        exp.getListaFAES().getListaFAEs().add(fae);
        ...
        Utilizador gestor = new Utilizador(2, "Gestor", "gestor", "gestor@centro.pt", "aA;1", "ddddd");
        Utilizador user3 = new Utilizador(2, "Joao", "gesor", "gestmail@emial.pt", "aA;11", "dddfdd");
        Utilizador user5 = new Utilizador(2, "Pedro", "gestr", "ger@emial.pt", "aA;12", "ddddsd");
        Utilizador user6 = new Utilizador(2, "David", "getor", "gewor@emial.pt", "aA;13", "ddsddd");
        Utilizador user7 = new Utilizador(2, "Delfim", "estor", "gesw@emial.pt", "aA;14", "dfdsddd");
        ce.getRegistoUtilizadoresNaoConfirmados().addUtilizador(user3);
        ce.getRegistoUtilizadoresNaoConfirmados().addUtilizador(user5);
        ce.getRegistoUtilizadoresNaoConfirmados().addUtilizador(user6);
        ce.getRegistoUtilizadoresNaoConfirmados().addUtilizador(user7);
        ce.getRegistoUtilizadores().getListaUtilizadores().add(gestor);
        ...
        Recurso rr = new Recurso("Agua");
        ce.getRegistoRecursos().addRecurso(rr);
        rr = new Recurso("Terra");
        Stand std = new Stand("cc");
        ce.getRegistoStands().registaStand(std);
        std = new Stand("dd");
        ce.getRegistoStands().registaStand(std);
        ce.getRegistoRecursos().addRecurso(rr);
