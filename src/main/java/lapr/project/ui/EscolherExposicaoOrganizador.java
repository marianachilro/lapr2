 ...
 */
public class EscolherExposicaoOrganizador extends JDialog {
    ...
    private ConfirmarRealizacaoDemonstracaoController controller;

    private List<Exposicao> listaExposOrganizador;

    private JComboBox comboBoxExpos;

    public EscolherExposicaoOrganizador(JFrame janelaPai, CentroExposicoes centro, Utilizador utilizador) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                c1.setEmailRep("email@centro.pt");
                ...
                c2.setEmailRep("email@centro.pt");
                ...
                new EscolherExposicaoOrganizador(null, ce, utill).setVisible(true);
            }
        });
    }
    ...
    public JPanel criarPainelOutput() {
        ...
        if (!listaExposOrganizador.isEmpty()) {
            ...
            JOptionPane.showMessageDialog(EscolherExposicaoOrganizador.this, "Não existem Exposições disponívies!",
    ...
    public JButton criarBotaoNext() {
        ...
        btn.addActionListener(new ActionListener() {
            ...
            @Override
            public void actionPerformed(ActionEvent e) {
                ConfirmarRealizacaoDemonstracaoUI confirmarRealizacaoDemoUI = new ConfirmarRealizacaoDemonstracaoUI(EscolherExposicaoOrganizador.this, controller);
                dispose();
            }
        });
        return btn;
