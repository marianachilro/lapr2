...
/**
 * Representa um dos Estados possíveis da Exposicao (Estado de "FAE Sem Demo").
 * @author marianachilro
 */
public class ExposicaoFAESemDemoEstado extends ExpoImpEstado{
    ...
    /**
     * Método que indica que a Demonstração está no Estado "FAE Sem Demo".
     *
    ...
    public boolean valida(){
        return super.getExposicao().getEstado().setFaeSemDemo();
    }
