 ...
 */
public class ExposicaoCandidaturasDemosAvaliadasEstado implements ExposicaoEstado{
    /**
     * A exposição.
     */
    ...
    public boolean setDemonstracaoCandidaturasDecididas() {
        if(valida()){
            this.exposicao.setEstado(new ExposicaoCandidaturasDemosDecididasEstado(this.exposicao));
            return true;
        }
        return false;
    }
    ...
    public boolean valida(){
       ...
       // if (dataHoje.isMaior(this.exposicao.getDataFimDcCandidaturasDemos())) {
         //   return true;
        //}
        return false;
    }
