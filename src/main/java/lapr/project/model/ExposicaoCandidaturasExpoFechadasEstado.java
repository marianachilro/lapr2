 ...
 */
public class ExposicaoCandidaturasExpoFechadasEstado implements ExposicaoEstado{
    ...
    public boolean setExposicaoConflitosDetetados() {
        if(valida()){
            this.exposicao.setEstado(new ExposicaoConflitosDetetadosExpoEstado(this.exposicao));
            return true;
        }
        return false;
    }
    ...
    public boolean valida(){
        //if(!this.exposicao.getListaConflitos().getListaConflitos().isEmpty())
          //  return true;
        return false;
    }
