 ...
 */
public class ExposicaoConflitosAtualizadosExpoEstado implements ExposicaoEstado{
    ...
    public boolean setExposicaoCandidaturasAtribuidas() {
        if(valida()){
            this.exposicao.setEstado(new ExposicaoCandidaturasExpoAtribuidasEstado(this.exposicao));
            return true;
        }
        return false;
    }
